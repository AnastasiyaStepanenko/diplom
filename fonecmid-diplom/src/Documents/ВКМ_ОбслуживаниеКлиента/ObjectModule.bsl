...
Процедура ПриЗаписи(Отказ)
	...
	ТаблицаДокумента = ОбщегоНазначения.СтрокиИзБуфераОбмена(); 
		
	Если ТаблицаДокумента.Данные = Неопределено Тогда
	...
	Иначе 
		Для Каждого Элемент Из ТаблицаДокумента.Данные Цикл
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)	
	...
	КонецЕсли;
	ОбщегоНазначения.СкопироватьВБуферОбмена(КопияДокумента);
